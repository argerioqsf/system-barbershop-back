...
import { UpdateSaleCouponUseCase } from '../../../src/modules/sale/application/use-cases/update-sale-coupon'
import {
  FakeSaleRepository,
...
let service: UpdateSaleCouponUseCase
...
beforeEach(() => {
  ...
  service = new UpdateSaleCouponUseCase(
    saleRepo,
    couponRepo,
    barberRepo,
    saleItemRepo,
