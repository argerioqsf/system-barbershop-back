...
import { LeadIsAlreadyEnrolled } from '../@errors/lead-is-already-enrolled'
import { LeadIsAlreadySubmittedDocuments } from '../@errors/leadIs-already-submitted-documents'
  ...
  async execute({
    ...
    if (matriculation !== undefined) {
      if (!lead.matriculation) {
        ...
        throw new LeadIsAlreadyEnrolled()
      }
    }
    ...
    if (documents !== undefined) {
      if (!lead.documents) {
        ...
        throw new LeadIsAlreadySubmittedDocuments()
      }
    }
